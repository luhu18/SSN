                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Kiboga District, Lwamata Town Council, Lunnya Village, Uganda</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Uganda: +256 779763525</p>
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://facebook.com/yoursustainableschoolsnetwork" target="_blank" rel="noopener noreferrer" className="bg-green-100 text-green-600 p-3 rounded-full hover:bg-green-200 transition duration-300" aria-label="Facebook">
                   ...
                   {/* mastodon*/}
                    ...
                    aria-label="Mastodon"
                    className="bg-green-100 text-green-600 p-3 rounded-full hover:bg-green-200 transition duration-300"
                   >
                    {/* Use the FaMastodon component directly */}
                    <RiMastodonFill className="w-6 h-6" />
                  </a>
