        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6 flex-wrap">
              {/* Social Media Icons */}
              <a href="https://facebook.com/yoursustainableschoolsnetwork" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white hover:text-green-300 transition-colors duration-200">
              ...
              {/* LinkedIn */}
              <a href="https://linkedin.com/company/yoursustainableschoolsnetwork" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-white hover:text-green-300 transition-colors duration-200">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Instagram */}
              <a href="https://instagram.com/yoursustainableschoolsnetwork" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white hover:text-green-300 transition-colors duration-200">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href="https://youtube.com/yoursustainableschoolsnetwork" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-white hover:text-green-300 transition-colors duration-200">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
